        ...
        <div className="profileRight">
          <div className="profileRightTop">
            <div className="profileCover">
              <img src={user.coverPicture || PUBLIC_FOLDER + "/post/cover.png"} alt="" className='profileCoverImg' />
              <img src={user.profilePicture || PUBLIC_FOLDER + "/person/prof.png"} alt="" className="profileUserImg" />
            </div>
